...
async def test_child_recovery(recovery: str, caplog: pytest.LogCaptureFixture) -> None:
    ...
    caplog.set_level(logging.INFO, logger="homeassistant.components.zentraly.models")
    ...
    child = create_device(api, "ZTBIN0100000001", "bb", via_device_id=parent.device_id)
    sibling = create_device(
        api, "ZTBIN0100000002", "cc", via_device_id=parent.device_id
    )
    listener = MagicMock()
